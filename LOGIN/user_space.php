          ...
          <div class="container formu">
            <form action="../PHP/AjoutOrganisateur.php" method="post">
              <div class="place line">
                  <label>Pseudo: 
                  <input type="text" name="pseudo" placeholder="type d'organisation" required></label>
              </div>
              <div  class="place line">
                  <label>nombres places:
                  <input type="email" name="mail" placeholder="Nombre de places" required></label>
              </div>
              <div  class="place line">
                  <label>Profession:
                  <input type="text" name="profession" placeholder="Profession" required></label>
              </div>
              <div  class="place line">
                  <label>Telephone:
                  <input type="text" name="num_tel" placeholder="telephone" required></label>
              </div>
              <div  class="place line">
                  <label>Nom:
                  <input type="text" name="nom" placeholder="Nom" required></label>
              </div>
              <div  class="place line">
                  <label>Prenom:
                  <input type="text" name="prenom" placeholder="Prenom" required></label>
              </div>
    ...
    <div class="modal-dialog modal-dialog-scrollable" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <button type="submit" class="btn btn-primary"><a href="../api.html"> <input type="button" value="payer" class='btn btn-primary'></a>Acheter</button>
            </form>
            <hr>
