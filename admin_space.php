...
<body>
  <!--modal de l'organisateur-->
<div class="modal fade" id="ajoutorganisateur" tabindex="-1" role="dialog" aria-labelledby="exampleModalScrollableTitle" aria-hidden="true">
    <div class="modal-dialog modal-dialog-scrollable" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalScrollableTitle">Ajouter un organisateur</h5>
        ...
        <div class="modal-body">
          <div class="container formu">
            <form action="../PHP/AjoutOrganisateur.php" method="post">
              <div class="place line">
                  <label>Pseudo: 
                  <input type="text" name="pseudo" placeholder="Nom de l'organisateur" required></label>
              </div>
              <div  class="place line">
                  <label>Mail:
                  <input type="email" name="mail" placeholder="Nom de la salle" required></label>
              </div>
              <div  class="place line">
                  <label>Profession:
                  <input type="text" name="profession" placeholder="Nom de la salle" required></label>
              </div>
              <div  class="place line">
                  <label>Telephone:
                  <input type="text" name="num_tel" placeholder="Nom de la salle" required></label>
              </div>
              <div  class="place line">
                  <label>Nom:
                  <input type="text" name="nom" placeholder="Nom de la salle" required></label>
              </div>
              <div  class="place line">
                  <label>Prenom:
                  <input type="text" name="prenom" placeholder="Nom de la salle" required></label>
              </div>
              <button type="submit" class="btn btn-primary">Ajouter</button>
            </form>
            <hr>
            <p>Supprimer un organisateur</p>
            <form action="../PHP/deleteorg.php" method="post">
              <select name="nom_org">
                <?php 
                $h=$bdd->query('SELECT * FROM organisatuer');
                while($y=$h->fetch()){
                ?>
                <option> <?php echo $y['nom'] ?></option>
                <?php } ?>
              </select>
  ...
  <!-- Modal de salle -->
  <div class="modal fade" id="ajoutsalle" tabindex="-1" role="dialog" aria-labelledby="exampleModalScrollableTitle" aria-hidden="true">
    <div class="modal-dialog modal-dialog-scrollable" role="document">
      <div class="modal-content">
        <div class="modal-header">
        ...
        <table class="table table-hover">
            <thead>
              <tr>
                ...
                <th><button type="button" class="btn btn-sm btn-success" data-toggle="modal" data-target="#ajoutsalle">
                <i class="fas fa-trash-alt"></i> Ajouter salle </button></th>
                <th><button type="button" class="btn btn-sm btn-success" data-toggle="modal" data-target="#ajoutorganisateur">
                <i class="fas fa-trash-alt"></i> Ajouter un organisateur </button></th>
            ...
            <tbody>
              ...
              <tr>
                ...
                $req = $bdd->query("SELECT * FROM events WHERE date_db='".$dateDeb."' AND date_fn='".$datefn."' AND id_salle='".$idSalle."'");
